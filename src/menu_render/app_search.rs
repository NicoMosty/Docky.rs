...
pub(crate) fn draw_app_search_strip_horizontal(
    ...
    use crate::menu::{
        APP_CARD_ICON, APP_CARD_ROW_H, APP_CARD_W, app_search_card_along, app_search_strip_y,
    };
    let s = args.render_scale;
    let settings = &args.dock.config.settings;
    ...
    pixmap.draw_pixmap(
        ...
        strip.as_ref(),
        &strip_paint,
        Transform::from_translate(0.0, row_y),
        None,
    );
}
...
pub(crate) fn draw_app_search_strip_vertical(
    ...
    use crate::menu::{
        APP_CARD_ICON, APP_CARD_W, MENU_PADDING, app_search_card_along, app_search_strip_y,
    };
    let s = args.render_scale;
    let settings = &args.dock.config.settings;
